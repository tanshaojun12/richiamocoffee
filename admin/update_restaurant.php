					...
					{        
									if($fsize>=1000000)
									...
									else
										{
												...
												$sql = "update branch set state_id='$_POST[c_name]', title='$res_name',email='$_POST[email]',phone='$_POST[phone]',url='$_POST[url]',o_hr='$_POST[o_hr]',c_hr='$_POST[c_hr]',o_days='$_POST[o_days]',address='$_POST[address]',image='$fnew' where branch_id='$_GET[res_upd]' ";  // store the submited data ino the database :images												mysqli_query($db, $sql);
													mysqli_query($db, $sql); 
                        ...
                        <div class="card card-outline-primary">
                            ...
                            <div class="card-body">
                                <form action='' method='post'  enctype="multipart/form-data">
                                    <div class="form-body">
                                       <?php $ssql ="select * from branch where branch_id='$_GET[res_upd]'";
											...
											<div class="col-md-6">
											 ...
											 <div class="col-md-12">
                                                <div class="form-group">
                                                 ...
                                                 <?php $ssql ="select * from state";
													$res=mysqli_query($db, $ssql); 
													while($rows=mysqli_fetch_array($res))  
													{
                                                       echo' <option value="'.$rows['state_id'].'">'.$rows['c_name'].'</option>';;
													}  
