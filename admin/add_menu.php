...
if(isset($_POST['submit']))          
{
	...
	else
		{
				...
				$fname = $_FILES['file']['name'];
								...
								$store = "Res_img/menu/".basename($fnew);
					...
					{        
									if($fsize>=1000000)
									...
									else
										{
												...
												$sql = "INSERT INTO menu(branch_id,title,slogan,price,img) VALUE('".$_POST['res_name']."','".$_POST['d_name']."','".$_POST['about']."','".$_POST['price']."','".$fnew."')";  // store the submited data ino the database :images
												mysqli_query($db, $sql); 
											 ...
											 <div class="col-md-12">
                                                <div class="form-group">
                                                 ...
                                                 <?php $ssql ="select * from branch";
													...
													{
                                                       echo' <option value="'.$row['branch_id'].'">'.$row['title'].'</option>';;
													}  
