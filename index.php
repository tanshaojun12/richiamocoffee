...
<body class="home">
        ...
        <header id="header" class="header-scroll top-header headrom">
            <nav class="navbar navbar-dark">
                <div class="container">
                    ...
                    <a class="navbar-brand" href="index.php">Richiamo Coffee</a>
        ...
        <section class="hero bg-image" data-image-src="/admin/branch_img/658ac58243b58.jpeg">
            <div class="hero-inner">
                <div class="container text-center hero-text font-weight-bold font-white">
                    <h1>RICHIAMO COFFEE ONLINE ORDERING SYSTEM </h1>
        ...
        <section class="popular">
            <div class="container">
                <div class="title text-xs-center m-b-30">
                    <h2>Our Signiture Coffee</h2>
                    <p class="lead">Choose the coffee that you intrested</p>
                </div>
                <div class="row">
						<?php 					
						$query_res= mysqli_query($db,"select * from menu LIMIT 6");
                                while($r=mysqli_fetch_array($query_res))
                                {
                                        
                                    echo '  <div class="col-xs-12 col-sm-6 col-md-4 food-item">
                                            <div class="food-item-wrap">
                                                <div class="figure-wrap bg-image" data-image-src="admin/branch_img/menu/'.$r['img'].'"></div>
                                                <div class="content">
                                                    <h5><a href="menu.php?branch_id='.$r['branch_id'].'">'.$r['title'].'</a></h5>
                                                    <div class="product-name">'.$r['slogan'].'</div>
                                                    <div class="price-btn-block"> <span class="price">RM '.$r['price'].'</span> <a href="menu.php?branch_id='.$r['branch_id'].'" class="btn theme-btn-dash pull-right">Order Now</a> </div>
                                                </div>
        ...
        <section class="how-it-works">
            <div class="container">
                <div class="text-xs-center">
                    <h2>How online ordering system works</h2>
                    <div class="row how-it-works-solution">
                        <div class="col-xs-12 col-sm-12 col-md-4 how-it-works-steps white-txt col1">
                            <div class="how-it-works-wrap">
                                <div class="step step-1">
                                    ...
                                    <p>Select the items you want to order by clicking on them or adding them to your virtual cart.</p>
                                </div>
                            </div>
                        </div>
                        <div class="col-xs-12 col-sm-12 col-md-4 how-it-works-steps white-txt col2">
                            <div class="step step-2">
                                ...
                                <h3>Do Payment</h3>
                                <p>Once you have completed your food selection, proceed to the checkout or payment section of the platform.</p>
                            </div>
                        </div>
                        <div class="col-xs-12 col-sm-12 col-md-4 how-it-works-steps white-txt col3">
                            <div class="step step-3">
                                ...
                                <h3>Wait for Food</h3>
                                <p>The restaurant staff will receive your order and prepare the food accordingly.</p>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-sm-12 text-center">
                        <p class="pay-info">Pay at counter</p>
                    </div>
                    <div class="col-sm-12 text-center">
                        <p class="pay-info">Online Payment</p>
                    </div>
                </div>
            </div>
        </section>
                ...
                <div class="row">
                    <div class="restaurant-listing">
                        ...
                        while($rows=mysqli_fetch_array($ress))
                        {
                            ...
                            $query= mysqli_query($db,"select * from branch where state_id='".$rows['state_id']."' ");
                            $rowss=mysqli_fetch_array($query);

                            echo ' <div class="col-xs-12 col-sm-12 col-md-6 single-restaurant all '.$rowss['state_id'].'">
														<div class="restaurant-wrap">
															<div class="row">
						
													
																<div class="col-xs-12 col-sm-9 col-md-12 col-lg-9">
																	<h5><a href="menu.php?branch_id='.$rows['branch_id'].'" >'.$rows['title'].'</a></h5> <span>'.$rows['address'].'</span>
																</div>
                ...
                <div class="bottom-footer">
                    <div class="row">
                        ...
                        <div class="col-xs-12 col-sm-4 address color-gray">
                            <h5>Address</h5>
                            <p>T2 Level 13, Residensi UTMKL,
                                Jalan Maktab 54000 Kuala Lumpur</p>
                            <h5>Phone: 03-2728 2926</a></h5>
                            <h5>Email: info@richiamocoffee.com</a></h5>
                        </div>
                        <div class="col-xs-12 col-sm-5 additional-info color-gray">
                            <h5>Addition informations</h5>
                            <p>RICHIAMO COFFEE is owned and operated by RICHIAMO COFFEE SDN. BHD.

                                It is a chained premium coffee shop.

                                The Company is guided by its firm belief in ensuring consistent supply of quality products and providing excellent service to its customers, and is steered by dedicated team to continuously achieve the organizational Vision and Mission.</p>
                        </div>
                    </div>
                </div>
